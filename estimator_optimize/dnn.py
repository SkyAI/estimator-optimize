...
from estimator_optimize import head as head_lib
from estimator_optimize import optimizers
...
def _dnn_model_fn(
  ...
  if isinstance(optimizer, six.string_types):
    optimizer = optimizers.get_optimizer_instance(**{'optimizer':optimizer, 'learning_rate':_LEARNING_RATE})
  else:
